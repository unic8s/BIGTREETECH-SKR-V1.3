...
#pragma once
 ...
 // Titan extruder
 #define PRINTSIPLE_HWMOD_TITAN
 // Trynamic TMC2100 stepper motor driver
 #define PRINTSIPLE_HWMOD_TMC2100
 // Filament sensor
 //#define PRINTSIPLE_HWMOD_FILAMENT_SENSOR
 // Some minor tweaks for better usage
 #define PRINTSIPLE_SWMOD_ERIK
...
#define STRING_CONFIG_H_AUTHOR "(Printsiple, Kossel Mini)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #if ENABLED(PRINTSIPLE_SWMOD_ERIK)
...
#define DELTA
  ...
  #define DELTA_HEIGHT 327.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal offset from middle of printer to smooth rod center.
  //#define DELTA_SMOOTH_ROD_OFFSET 150.0 // mm
  #define DELTA_SMOOTH_ROD_OFFSET 148.5 // Erik

  // Horizontal offset of the universal joints on the end effector.
  //#define DELTA_EFFECTOR_OFFSET 22.5 // mm
  #define DELTA_EFFECTOR_OFFSET 24.5 // Erik
 ...
 */
#if ENABLED(PRINTSIPLE_HWMOD_TMC2100)
...
#if ENABLED(PRINTSIPLE_HWMOD_TITAN)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 388 }
#else
 ...
 */
#if DISABLED(PRINTSIPLE_SWMOD_ERIK)
